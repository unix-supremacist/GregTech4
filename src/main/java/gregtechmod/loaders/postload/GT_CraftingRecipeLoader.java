...
public class GT_CraftingRecipeLoader implements Runnable {
	...
	public void run() {
	    ...
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Cooperite_Medium		.get(2), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.Cooperite), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    ...
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Cooperite_Large		.get(1), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.Cooperite), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
    	...
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1, 62), new Object[] {"RCR", "AEA", "RCR", 'C', OrePrefixes.circuit.get(Materials.Advanced), 'A', GT_OreDictNames.craftingRawMachineTier02, 'E', GT_OreDictNames.craftingExtractor, 'R', GT_OreDictNames.craftingPlateSteel});
    	...
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1, 38), new Object[] {"RPR", "CGC", "RPR", 'C', OrePrefixes.circuit.get(Materials.Advanced), 'P', GT_OreDictNames.craftingPump, 'G', "glassReinforced", 'R', GT_OreDictNames.craftingPlateSteel});
        ...
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Gold				.get(8), false, false, true, new Object[] {GT_Items.Credit_Cooperite.get(1)});
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Cooperite			.get(8), false, false, true, new Object[] {GT_Items.Credit_Osmium.get(1)});
        ...
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Cooperite			.get(1), false, false, true, new Object[] {GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1), GT_Items.Credit_Gold.get(1)});
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Osmium				.get(1), false, false, true, new Object[] {GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1), GT_Items.Credit_Cooperite.get(1)});
        ...
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Greg_Gold			.get(8), false, false, true, new Object[] {GT_Items.Credit_Greg_Cooperite.get(1)});
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Greg_Cooperite		.get(8), false, false, true, new Object[] {GT_Items.Credit_Greg_Osmium.get(1)});
        ...
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Greg_Cooperite		.get(1), false, false, true, new Object[] {GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1), GT_Items.Credit_Greg_Gold.get(1)});
        GT_ModHandler.addShapelessCraftingRecipe(GT_Items.Credit_Greg_Osmium		.get(1), false, false, true, new Object[] {GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1), GT_Items.Credit_Greg_Cooperite.get(1)});
        ...
        if (GregTech_API.sRecipeFile.get(GT_ConfigCategories.Recipes.harderrecipes, "nanosaber", true)) {
        	if (GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2Item("nanoSaber", 1)))
        		GT_ModHandler.addCraftingRecipe(GT_ModHandler.getIC2Item("nanoSaber", 1), false, new Object[] {"PI ", "PI ", "CLC", 'L', OrePrefixes.battery.get(Materials.Master), 'I', OrePrefixes.plateAlloy.get("Iridium"), 'P', OrePrefixes.plate.get(Materials.Cooperite), 'C', OrePrefixes.circuit.get(Materials.Master)});
        }
