	...
	public static void addStandardDescriptions() {
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						GT_ModHandler.getIC2Item("ironFence", 1),
						GT_ModHandler.getIC2Item("ironFence", 1),
						new ItemStack(GregTech_API.sBlockList[1], 1, 2),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1, 3),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1, 4),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						new ItemStack(GregTech_API.sBlockList[1], 1, 5),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"Emits Redstone when finished."
				},
				new ItemStack[] {
						null,
						null,
						null,
						GregTech_API.getGregTechItem(32, 1, 0),
						new ItemStack(GregTech_API.sBlockList[1], 1, 6),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"One Controllerblock, and as many",
			    		"'stupid' Storageblocks as you want.",
			    		...
			    		"Storageblocks are NOT TileEntities,",
			    		"what means that they cause as much",
			    		"Lag as a random Dirtblock. And the",
			    		"Controller Block only checks ONCE",
			    		"for the Storages, so no",
			    		"Blockiterationlag, AT. ALL. Anyone,",
			    		"who says that they lag gets murdered!"
				},
				new ItemStack[] {
						null,
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[0], 1, 6),
						new ItemStack(GregTech_API.sBlockList[1], 1, 7),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1, 8),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"Energy Orbs and Lapotron Packs",
			    		"",
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1, 9),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"",
			    		"The Energy Orb inside stores enough",
			    		"to charge your QSuit almost instantly",
			    		"",
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,10),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			        	...
			        	"Side = Output",
			        	"",
			        	"You can pipe Lava into this Device"
				},
				new ItemStack[] {
						null,
						null,
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,11),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			        	"Electrolyzer",
			        	"This is a Machine to seperate",
			        	"Molecules and electrolyze",
			        	"Watercells.",
			        	"",
			        	"It has a maximum Consumption Rate",
			        	"of 128EU/t, and its Maxinput is",
			        	"128EU/t. The time it needs depends",
			        	"on the Recipe you use.",
			        	"",
			        	"It needs Tin Cells for some Recipes,",
			        	"which you put in the Bottom Left Slot",
			        	"",
			        	"Top = Input",
			        	"Bottom = Tin Cells",
			        	"Side = Output",
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,25),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			        	"Grinder",
			        	"This Machines purpose is to",
			        	"macerate and grind Ores.",
			        	"It can ONLY grind Ores, don't",
			        	"try regular Macerator Recipes.",
			        	"It has a fixed Consumption Rate",
			        	"of 128EU/t, and its Maxinput is",
			        	"128EU/t. The time it needs is",
			        	"5 seconds per Ore Block",
			        	"It needs Water for most Recipes,",
			        	"which you put in the Bottom Left Slot",
			        	"Top = Input",
			        	"Bottom = Water",
			        	"Side = Output",
				...
				new ItemStack[] {
						null,
						new ItemStack(Block.waterStill, 1),
						new ItemStack(GregTech_API.sBlockList[0], 1,14),
						new ItemStack(GregTech_API.sBlockList[0], 1,13),
						new ItemStack(GregTech_API.sBlockList[1], 1,28),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,29),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			        	"Sawmill",
			        	"This Device turns your Logs",
			        	"into more Planks, than a normal",
			        	"Steve can produce with his Hands.",
			        	"",
			        	"Its byproduct, Wood Pulp, can be",
			        	"compressed into special Planks,",
			        	"which are burning like Charcoal.",
			        	"",
			        	"It needs Water for most Recipes,",
			        	"which you put in the Bottom Left Slot",
			        	"Top = Input",
				...
				new ItemStack[] {
						null,
						null,
						GT_MetaItem_Material.instance.getStack(15, 1),
						GT_MetaItem_Dust.instance.getStack(15, 1),
						new ItemStack(GregTech_API.sBlockList[1], 1,32),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						GT_ModHandler.getIC2Item("industrialTnt", 1, new ItemStack(Block.tnt, 1)),
						new ItemStack(GregTech_API.sBlockList[1], 1,31),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"nearly infinite EU/p and it has",
			    		"no Cableloss!",
			    		...
			    		"",
			    		"You also need it for the Fusion Reactor.",
			    		"Some Machines will require that high",
			    		"Voltage in a short period of time."
				},
				new ItemStack[] {
						null,
						null,
						GregTech_API.getGregTechItem(3, 1, 2),
						new ItemStack(GregTech_API.sBlockList[1], 1,12),
						new ItemStack(GregTech_API.sBlockList[1], 1,15),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"and ALL Players by Rightclicking it.",
			    		"",
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,13),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						GT_ModHandler.getIC2Item("matter", 1),
						new ItemStack(GregTech_API.sBlockList[1], 1, 14),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,16),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"red Outputfacing. Buffers do the same,",
				...
				new ItemStack[] {
						null,
						null,
						new ItemStack(GregTech_API.sBlockList[1], 1,19),
						new ItemStack(GregTech_API.sBlockList[1], 1,18),
						new ItemStack(GregTech_API.sBlockList[1], 1,17),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						null,
						null,
						GT_OreDictUnificator.get("dustSilver", 1),
						GregTech_API.getGregTechItem(0, 1, 17),
						new ItemStack(GregTech_API.sBlockList[2], 1, 1),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"Recipe for Energycrystals and",
			    		"Lapotroncrystals, but they are",
			    		"Redpower Compatible.",
			    		"",
			    		"They also sometimes drop random",
			    		"other Gems, like Garnet for Ruby",
			    		"or green Sapphire for Sapphire",
			    		"in addition.",
			    		"",
			    		""
				},
				new ItemStack[] {
						null,
						GregTech_API.getGregTechItem(0, 1, 32),
						new ItemStack(GregTech_API.sBlockList[2], 1, 3),
						GregTech_API.getGregTechItem(0, 1, 33),
						new ItemStack(GregTech_API.sBlockList[2], 1, 4),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"Gem- and Iridium Blocks)",
			    		"Production Chain:",
			    		"macerating Bauxite Ore",
			    		"electrolyzing 24 Bauxite Dust",
			    		"smelting Aluminium Dust in a",
			    		"Blast Furnace"
				},
				new ItemStack[] {
						new ItemStack(GregTech_API.sBlockList[0], 1, 7),
						GregTech_API.getGregTechItem(0, 1, 18),
						GregTech_API.getGregTechItem(1, 1, 18),
						GregTech_API.getGregTechItem(1, 1, 17),
						new ItemStack(GregTech_API.sBlockList[2], 1, 5),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						new ItemStack(GregTech_API.sBlockList[0], 1, 8),
						GregTech_API.getGregTechItem(0, 1, 19),
						GregTech_API.getGregTechItem(1, 1, 19),
						GregTech_API.getGregTechItem(1, 1, 17),
						new ItemStack(GregTech_API.sBlockList[2], 1, 5),
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						null,
						null,
						GT_OreDictUnificator.get("plateAlloyIridium", 1),
						GT_ModHandler.getIC2Item("iridiumOre", 1),
						new ItemStack(GregTech_API.sBlockList[2], 1, 2),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"Water based Coolant Cells, and can",
			    		"also hold six times more Heat.",
			    		"",
			    		"Helium Cells can also be used for",
			    		"making Luminators and Mininglasers",
			    		"",
			    		"",
			    		"",
			    		"",
				...
				new ItemStack[] {
						GregTech_API.getGregTechItem( 2, 1, 6),
						GregTech_API.getGregTechItem( 2, 1, 3),
						GregTech_API.getGregTechItem(34, 1, 0),
						GregTech_API.getGregTechItem(35, 1, 0),
						GregTech_API.getGregTechItem(36, 1, 0),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		"Destructopack",
			    		"Open its GUI via rightclick and",
				...
				new ItemStack[] {
						...
						null,
						null,
						GregTech_API.getGregTechItem(33, 1, 0),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						GregTech_API.getGregTechItem(43, 1, 0),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						GregTech_API.getGregTechItem(45, 1, 0),
						GregTech_API.getGregTechItem(37, 1, 0),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				...
				new ItemStack[] {
						...
						null,
						null,
						GregTech_API.getGregTechItem(40, 1, 0),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"",
			    		"Or better. Use the Industrial",
			    		"Grinder to get even more",
			    		"Resources!",
			    		""
				},
				new ItemStack[] {
						...
						null,
						null,
						GregTech_API.getGregTechItem(46, 1, 0),
						null,
						null,
						null,
						null,
		...
		new GT_ComputercubeDescription(
				new String[] {
			    		...
			    		"",
			    		"The Energy Orb inside it must be",
			    		...
			    		"while using it.",
			    		"",
			    		"We also dont even know, if this",
			    		"Weapon has any effect AT ALL.",
			    		"",
			    		"",
			    		"",
			    		""
				...
				new ItemStack[] {
						...
						null,
						null,
						GregTech_API.getGregTechItem(47, 1, 0),
						null,
						null,
						null,
						null,
